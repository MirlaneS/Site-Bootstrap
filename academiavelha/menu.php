...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="frmaluno.php">Formulário Aluno</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="funcionario.php">Formulário Funcionário</a>
            </li>
          ...
          <form class="form-inline my-2 my-lg-0">
            ...
            <img src="imagens/carrinho.jpg" style=width:50px;height:50px;></a>
            <?php 
              if($_SESSION["quant"]>0){
                 echo $_SESSION["quant"]; 
              }
